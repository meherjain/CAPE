...
//#define TS_XP_ADC               ADC_CTL_CH7
//#define TS_YP_PIN               GPIO_PIN_5//R
//#define TS_YP_ADC               ADC_CTL_CH6
//#define TS_XN_PERIPH            SYSCTL_PERIPH_GPIOQ
//#define TS_XN_BASE              GPIO_PORTQ_BASE
//#define TS_XN_PIN               GPIO_PIN_1//L
...
TouchScreenInit(uint32_t ui32SysClock)
{
    ...
    /* Commented by Vivek on 4/19/2016. ADC trigger changed to software */
//    ADCSequenceConfigure(ADC0_BASE, 3, ADC_TRIGGER_TIMER, 0);
    ...
    /* Commented by Vivek on 4/19/2016. ADC is made polled instead of isr based */
    //
    // Enable the ADC sample sequence interrupt.
    //
//    ADCIntEnable(ADC0_BASE, 3);

    /* Commented by Vivek on 4/19/2016. This interrupt is enabled
     * in main */
//    IntEnable(INT_ADC0SS3);
    /* Added by Vivek on 4/19/2016. This interrupt is set to lower
     * priority so that other interrupts can interrupt it
     */
//    IntPrioritySet(INT_ADC0SS3_TM4C129,0xE0);
    ...
    if((HWREG(TIMER1_BASE + TIMER_O_CTL) & TIMER_CTL_TAEN) == 0)
    {
        ...
        TimerLoadSet(TIMER1_BASE, TIMER_A, (ui32SysClock / 400) - 1);
